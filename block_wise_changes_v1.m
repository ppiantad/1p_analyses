...
collect_original_sum = sum(respClass_all_array{1, arrays_to_examine(1)}==1)
...
not_collect_sum = sum(respClass_all_array{1, arrays_to_examine(1)} ~=1)
...
figure; hold on;
h(1) = shadedErrorBar(ts1, nanmean(neuron_mean_array{1,arrays_to_examine(1)}(collect_conserved  ==1, :)), nanmean(neuron_sem_array{1, arrays_to_examine(1)}(collect_conserved  ==1, :)), 'lineProps', {'color', acton(1,:)});
h(2) = shadedErrorBar(ts1, nanmean(neuron_mean_array{1,arrays_to_examine(2)}(collect_conserved  ==1, :)), nanmean(neuron_sem_array{1, arrays_to_examine(2)}(collect_conserved  ==1, :)), 'lineProps', {'color', acton(200,:)});
...
%%
figure; hold on;
h(1) = shadedErrorBar(ts1, nanmean(neuron_mean_array{1,arrays_to_examine(1)}(collect_lost  ==1, :)), nanmean(neuron_sem_array{1, arrays_to_examine(1)}(collect_lost  ==1, :)), 'lineProps', {'color', acton(1,:)});
h(2) = shadedErrorBar(ts1, nanmean(neuron_mean_array{1,arrays_to_examine(2)}(collect_lost  ==1, :)), nanmean(neuron_sem_array{1, arrays_to_examine(2)}(collect_lost  ==1, :)), 'lineProps', {'color', acton(200,:)});
...
%%
figure; hold on;
h(1) = shadedErrorBar(ts1, nanmean(neuron_mean_array{1,arrays_to_examine(1)}(collect_remapped  ==1, :)), nanmean(neuron_sem_array{1, arrays_to_examine(1)}(collect_remapped  ==1, :)), 'lineProps', {'color', acton(1,:)});
h(2) = shadedErrorBar(ts1, nanmean(neuron_mean_array{1,arrays_to_examine(2)}(collect_remapped  ==1, :)), nanmean(neuron_sem_array{1, arrays_to_examine(2)}(collect_remapped  ==1, :)), 'lineProps', {'color', acton(200,:)});
