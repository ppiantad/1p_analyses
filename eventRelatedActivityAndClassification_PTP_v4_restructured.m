...
uv.evtSigWin.pre_choice = [-4 0]; %for pre-choice   [-4 0]    [-4 1]                              %period within time window that response is classified on (sec relative to event)
uv.evtSigWin.post_choice = [0 2]; %for SHK or immediate post-choice [0 2]
uv.evtSigWin.consumption = [1 3]; %for REW collection [1 3]
% 
