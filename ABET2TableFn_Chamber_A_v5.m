function [data, ABETdata, Descriptives, block_end] = ABET2TableFn_Chamber_A_v5(filename, dummy)
...
% [ABETdata]=readmatrix(filename,'OutputType','char');


Headers={'Trial','Block','ForceFree','bigSmall','TrialPossible','stTime','choiceTime'...
    'collectionTime','shock','omission','omissionALL','WL','WSLScode','win_stay','lose_shift','lose_omit','smallRew','bigRew'};
data=table(zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1),zeros(80,1));
data.Properties.VariableNames([1:18])=Headers;
