            ...
            if num_iteration <= 1
                ...
                for ii = 1:size(animalIDs, 1)
                    ...
                    if isfield(final.(currentanimal), session_to_analyze)
                        if strcmp(final.(currentanimal).experimental_grp, experimental_grp_to_analyze) 
                        mouse_count = mouse_count + 1;
                        mouse_ids_added(mouse_count) = {currentanimal};
                        ...
                        for u = 1:size(ca,1)
                            ...
                            [zall_baselined, zall_window, zall_session, caTraceTrials, zscored_caTraceTrials] = align_and_zscore_context(unitTrace, eTS, uv, time_array, zb_session, zsd_session, u, use_normalized_time);
                            ...
                            zall_mouse{mouse_count, num_comparison}(u) = {zall};
                            caTraceTrials_mouse{mouse_count, num_comparison}(u) = {caTraceTrials};
