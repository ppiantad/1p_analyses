function [zall_baselined, zall_window, zall_session, caTraceTrials, zscored_caTraceTrials, zall_luthi] = align_and_zscore_context(unitTrace, eTS, uv, time_array, zb_session, zsd_session, u, use_normalized_time)
