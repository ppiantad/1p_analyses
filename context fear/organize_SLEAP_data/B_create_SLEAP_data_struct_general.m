...
top_level_directory = 'D:\Context Data\PFC Last\Raw Data\PFC alone\Raw Data'; % Update this to your top-level directory
...
for k = 1:length(SLEAP_and_freeze_combined_filepaths)
    ...
    current_animal = file_path_string{7}; % 
    current_session_raw = file_path_string{8};
