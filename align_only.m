function [caTraceTrials, trial_ca, StartChoiceCollect_times, zscored_caTraceTrials] = align_only(BehavData, unitTrace, eTS, uv, time_array, zb_session, zsd_session, u, use_normalized_time)
...
for t = 1:size(eTS,1)
    ...
    unitTrace_zscored = normalize(unitTrace); %normalize is the same as zscore but it ignores NaNs, which is important if using CASCADE-based data
