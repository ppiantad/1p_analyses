...
%PTP: shouldn't this be what is used? 
gcamp_raw_y=(g_output.gcamp_raw  -mean(g_output.gcamp_raw  ))./std(g_output.gcamp_raw  );
...
%%
%%
test = sgolayfilt(encoding_output.coefs(1, :), 9, 21);
...
figure; plot(encoding_output.coefs(1, 127:151));
figure; plot(encoding_output.coefs(1, 152:176));
...
sixth = encoding_output.coefs(1, 127:151);
seven = encoding_output.coefs(1, 152:176);


all_coefs = [first; second; third; fourth; fifth; sixth; seven];
