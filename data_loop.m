...
for ii = 1:size(animalIDs,1)
    ...
    if isfield(final.(currentanimal), session_to_analyze)
        ...
        [BehavData,trials, varargin_identity_class]=TrialFilter_test(BehavData, 'OMITALL', 0, 'BLANK_TOUCH', 0, 'BLOCK', 2, 'BLOCK', 3, 'SHK', 0); %'REW', 1.2, 'BLOCK', 2, 'BLOCK', 3, 'SHK', 0; 'LOSS_PLUS_ONE', 1, 'SHK', 0, 'BLANK_TOUCH', 0; 'LOSS_PLUS_ONE', 0, 'REW', 1.2, 'OMITALL', 0, 'BLANK_TOUCH', 0, 'SHK', 0, 'BLOCK', 2, 'BLOCK', 3
